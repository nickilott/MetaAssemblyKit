...
def runSpades(infile, outfile):
    ...
    '''
    job_memory=PARAMS.get("spades_memory")
    memory=job_memory[:-1]
    job_threads=PARAMS.get("spades_threads")
...
###################################################################
###################################################################
@transform(filterContigs, suffix(".filtered.contigs.fa"), ".summary.tsv")
